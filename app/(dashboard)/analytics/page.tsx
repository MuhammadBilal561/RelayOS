...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="p-6 sm:p-10">
      <p className="font-mono text-xs uppercase tracking-[0.2em] text-ink-700/40">Analytics</p>
      <h1 className="mt-1 font-display text-2xl font-semibold text-ink-950">Revenue recovery</h1>
      <p className="mt-2 text-sm text-ink-700/60">Last 30 days, computed live from Postgres — nothing here is mocked.</p>
