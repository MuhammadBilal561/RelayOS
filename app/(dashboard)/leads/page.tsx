...
export default async function LeadsPage() {
  ...
  return (
    <div className="p-6 sm:p-10">
      <p className="font-mono text-xs uppercase tracking-[0.2em] text-ink-700/40">Leads</p>
      <h1 className="mt-1 font-display text-2xl font-semibold text-ink-950">Pipeline</h1>
      <p className="mt-2 text-sm text-ink-700/60">
        Ranked by lead score — a deterministic blend of contact info captured, urgency language detected, and
        engagement depth. Recalculated after every message, not an LLM self-report.
      </p>
